...
- Load path etc.
  ...
  #+RESULTS: starter-kit-load-paths
  : /home/jcabraham/.emacs.d/custom.el
...
- Starter kit function definitions in [[file:starter-kit-defuns.org][starter-kit-defuns]]
  ...
  #+RESULTS:
  : Loaded /home/jcabraham/.emacs.d/starter-kit-defuns.el
...
- Key Bindings in [[file:starter-kit-bindings.org][starter-kit-bindings]]
  ...
  #+RESULTS:
  : Loaded /home/jcabraham/.emacs.d/starter-kit-bindings.el
...
- Miscellaneous settings in [[file:starter-kit-misc.org][starter-kit-misc]]
  ...
  #+RESULTS:
  : Loaded /home/jcabraham/.emacs.d/starter-kit-misc.el
...
- Registers for jumping to commonly used files in [[file:starter-kit-registers.org][starter-kit-registers]]
  ...
  #+RESULTS:
  : Loaded /home/jcabraham/.emacs.d/starter-kit-registers.el
...
#+RESULTS: m-x-customize-customizations
: t

** Load Custom starter-kit files
#+begin_src emacs-lisp
(starter-kit-load "python")
(starter-kit-load "js")
...
(starter-kit-load "sql")
(starter-kit-load "translate")
...
#+RESULTS:
: Loaded /home/jcabraham/.emacs.d/starter-kit-yasnippet.el
